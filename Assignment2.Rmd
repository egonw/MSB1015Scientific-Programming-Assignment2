...
---
# Introduction
The assignment is to query wikidata for information about the chemical class, alkanes. Therefore it is necessary to design a query that will 
...
# plot error
ncompo <- c(1:4)
plot(ncompo, error$val[2:5], type = "p", pch = 16,  xlab = "Number of principle components", 
     ylab = "RMSEP [K]", main = "RMSE of Prediction against Number of Principle Components")
# correlation of results 
for (i in 1:4) {
  corr[i] <- cor(predicted[,,i], ytest)
}
plot(ncompo[1:4], corr, type = "p", xlab = "Number of principle components", ylab = "Correlation",
